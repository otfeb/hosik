...
public class ExObject_01 {
	...
	String name;		// 인스턴스 변수 ... 일반인스턴스 맴버변수는 객체생성후 각각 다른값을 가질수있다
	static final String MESSAGE = "Happy Day";		// static 맴버변수는 주로 상수로 선언할때 사용하며 인스턴스 변수없이 클래스명으로 접근가능하다
