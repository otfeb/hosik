...
%>
<button type="button" class="btn btn-outline-info" onclick="location.href='addForm.jsp'">로그인</button>
<table class="table table-bordered" style="width: 750px">
	...
	<tr align="center" valign="middle">
		...
		<td align="center" colspan="2" float="left">
			...
			<input type="button" class="btn btn-danger btn-sm" value="삭제" onclick="location.href=''">
		</td>
	</tr>
	<%}
	%>
