...
<form action="addAction.jsp" method="post">
	<table class="table table-bordered" style="width: 350px">
		<tr>
			<th>이름</th>
				<td>
					<input type="text" class="form-control" style="width:180px;" name="intro_name">
				</td>
		</tr>
		...
		<tr>
			<th>전화번호</th>
				<td>
					...
					-<input type="text" size="4" name="intro_hp2">-<input type="text" size="4" name="intro_hp3">
				</td>
		</tr>
