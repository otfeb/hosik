		...
		<table class="table table-bordered" style="width: 300px;">
			<tr>
				...
				<td>
					...
					style="width: 120px;" placeholder="이름" value="<%=dto.getName() %>">
				</td>
			</tr>
			...
			<tr>
				<th>운전면허</th>
				<td>
					<input type="checkbox" name="driver" <%=dto.getDriver().equals("있음")?"checked":"" %>>운전여부
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-warning"<%--  onclick="location.href='list.jsp?num=<%=dto.getNum() %>'" --%>>팀원정보수정</button>
